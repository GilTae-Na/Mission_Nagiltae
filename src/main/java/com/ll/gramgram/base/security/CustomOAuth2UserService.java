...
// final 필드를 가지고 생성자(Constructor)를 자동으로 생성
@Slf4j
// 자바에서 로깅(logging)을 쉽게 할 수 있도록 지원하는 롬복
// 소프트웨어가 동작하는 동안 발생하는 이벤트와 정보를 기록하는 것
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    //커스터 만들면 기본의 것 동작 안댐, 다 설정해야 한다
    //구조 자체는 규걱이라고 봐도 무방하다
